...
public class ReportController {
	...
	@GetMapping("{id}")
	public ResponseEntity<?> printFinalReport(@PathVariable String id) throws FileNotFoundException, JRException {

		final JasperPrint jasperPrint = reportService.exportFinalReport(id);
