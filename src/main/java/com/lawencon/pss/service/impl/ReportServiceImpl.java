...
public class ReportServiceImpl implements ReportService {
	...
	@Override
	public JasperPrint exportImage(String imageId) throws FileNotFoundException, JRException {
		final var imageModel = fileService.getFileById(imageId);

		File file = ResourceUtils.getFile("classpath:companies.jasper");

		JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource((Collection<?>) imageModel);
